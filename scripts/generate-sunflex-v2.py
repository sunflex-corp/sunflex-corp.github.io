#!/usr/bin/env python3
"""Generate only the seven SUNFLEX corporate pages. Product assets are read-only."""
...
<header class="site-header"><div class="wrap header-inner"><a class="logo" href="/" aria-label="썬플렉스 홈"><img src="/brand/sunflex-wordmark-white.svg" width="150" height="35" alt="SUNFLEX"></a><nav class="desktop-nav" aria-label="주 메뉴">{links}</nav><a class="header-cta" href="/contact/">도입 문의 {ARROW}</a><button class="menu-toggle" type="button" aria-expanded="false" aria-controls="mobile-nav" hidden>메뉴</button></div><nav class="mobile-nav" id="mobile-nav" aria-label="모바일 메뉴">{links}<a href="/contact/">도입 문의 {ARROW}</a></nav></header>'''

def footer():
    return f'''<footer class="site-footer"><div class="wrap"><div class="footer-top"><div class="footer-brand"><a href="/" aria-label="썬플렉스 홈"><img src="/brand/sunflex-wordmark-white.svg" width="170" height="39" alt="SUNFLEX" loading="lazy"></a><p>산업현장을 위한 스마트 안전 솔루션.<br>제품 정보부터 도입 상담까지 안내합니다.</p></div><nav class="footer-links" aria-label="하단 메뉴"><a href="/solutions/">적용 분야</a><a href="/products/">제품</a><a href="/company/">기업소개</a><a href="/cases/">고객지원</a><a href="/contact/">도입 문의</a></nav><div class="footer-contact"><strong>(주)썬플렉스</strong><a href="tel:0319912285">031-991-2285</a><a href="mailto:jiyoueng@daum.net">jiyoueng@daum.net</a><p>경기도 시흥시 신천동 845-18</p></div></div><div class="footer-bottom"><span>© 2026 SUNFLEX. All rights reserved.</span><a href="/privacy/">개인정보·현장 데이터 안내</a></div><div class="wordmark-end" aria-hidden="true">SUNFLEX</div></div></footer>'''
...
def company():
    body=head('기업소개','현장 안전관리에 필요한<br>기술을 제안합니다.','건설·제조·물류 현장의 안전장비와 솔루션. 썬플렉스는 현장 담당자가 필요한 제품을 검토할 수 있도록 제품 정보와 상담을 제공합니다.','<div class="big-name" aria-hidden="true">SUNFLEX</div>','company-head')
